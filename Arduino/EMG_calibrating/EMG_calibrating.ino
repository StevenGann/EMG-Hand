...
{
	gestureVals[gestureID][0] = clean_max1 * 1.1f;
	gestureVals[gestureID][1] = clean_min1 * 0.9f;
	gestureVals[gestureID][2] = clean_max2 * 1.1f;
	gestureVals[gestureID][3] = clean_min2 * 0.9f;
	gestureVals[gestureID][4] = clean_max3 * 1.1f;
	gestureVals[gestureID][5] = clean_min3 * 0.9f;
	gestureVals[gestureID][6] = clean_max4 * 1.1f;
	gestureVals[gestureID][7] = clean_min4 * 0.9f;
