                                ...
                                if (successFlag > 0) {
                                        ...
                                        while (!kbhit()) {
											...
											TransferBuffer(devHandle);
												...
												cout << "DATA: " << FastInputsData[0] << endl;
                                               /* if (statusCount++ >= 20) {
                                                        statusCount = 0;
                                                        cout << endl;
                                                        ...
                                                        cout << "  Pkts: " << GetGoodPackets(devHandle) << " good " << GetBadPackets(devHandle) << " bad " << GetDroppedPackets(devHandle) << " dropped" << endl;
                                                }*/
